      ...
      >
        <Container maxWidth="md">
          ...
          >
            ...
            >
              AI-powered itinerary generator that creates personalized travel
              plans, suggests activities, and optimizes routes based on your
          ...
          <Grid container spacing={4}>
            {[
              ...
              },
              {
                ...
                description:
                  "Discover unique activities, attractions, and experiences tailored to your preferences.",
              },
              {
                title: "Route Optimization",
                description:
                  "Get optimized routes that minimize travel time and maximize your experience.",
              },
              {
                title: "Real-time Updates",
                description:
                  "Receive real-time updates on weather, events, and local recommendations.",
              },
            ].map((feature, index) => (
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center" }}>
            ...
            <ScrollAnimation direction="up" distance={30} delay={0.2}>
              ...
              >
                {`Currently in concept phase. Follow the progress and get notified
                when it's ready!`}
              </Typography>
            </ScrollAnimation>
